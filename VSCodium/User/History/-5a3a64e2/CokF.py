...
class Gui:
    ...
    sensitivity_spinbox = ttk.Spinbox(master = window, from_ = decimal.Decimal('0.01'), to = decimal.Decimal('10.0'), command = update_sensitivity, validatecommand = (window.register(float_validate)))
