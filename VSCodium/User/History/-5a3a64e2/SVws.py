...
class Gui:
    ...
    fov_spinbox = ttk.Spinbox(master = window, from_ = decimal.Decimal('10.0'), to = decimal.Decimal('180.0'), increment = 0.1, value = Settings.fov, command = Gui.update_fov)
    fov_spinbox.config(command = lambda: Gui.update_fov(Gui))
