...
class Gui:
    ...
    fov_spinbox = ttk.Spinbox(master = window, from_ = decimal.Decimal('10.0'), to = decimal.Decimal('180.0'), increment = 0.1, command = update_fov, validatecommand = (window.register(float_validate)))
    sensitivity_spinbox = ttk.Spinbox(master = window, from_ = decimal.Decimal('0.01'), to = decimal.Decimal('10.0'), increment = 0.01, command = update_sensitivity, validate = 'all' ,validatecommand = (window.register(float_validate)))
