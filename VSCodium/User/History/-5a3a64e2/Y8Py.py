...
class Gui:
    ...
    sensitivity_scale = ttk.Scale(master = window, orient = 'horizontal', from_ = decimal.Decimal('0.01'), to = decimal.Decimal('10.0'), command = update_sensitivity, validatecommand = (window.register(float_validate)))
