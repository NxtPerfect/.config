...
class Gui:
    ...
    def update_fov(value):
        Settings.fov = decimal.Decimal(value)
    ...
    fov_scale = ttk.Spinbox(master = window, from_ = decimal.Decimal('10.0'), to = decimal.Decimal('180.0'), increment = 0.1, textvariable = Settings.fov, command = update_fov)
