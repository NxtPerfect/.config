...
class Gui:
    ...
    fov_spinbox = ttk.Spinbox()
    sensitivity_spinbox = 0
    duration_spinbox = 0
    keybind_spinbox = 0
    ...
    self.fov_spinbox = ttk.Spinbox(master = window, from_ = decimal.Decimal('10.0'), to = decimal.Decimal('180.0'), increment = 0.1, value = Settings.fov, command = update_fov)
    self.sensitivity_scale = ttk.Scale(master = window, orient = 'horizontal', from_ = decimal.Decimal('0.01'), to = decimal.Decimal('10.0'), value = Settings.in_game_sensitivity, command = update_sensitivity)
